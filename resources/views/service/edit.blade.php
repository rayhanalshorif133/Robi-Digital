                ...
                <div class="modal-body">
                    <div class="px-2">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name" class="required">Api Key</label>
                                    <input type="text" name="api_key" id="api_key" required class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="subs_duration" id="subs_duration"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
